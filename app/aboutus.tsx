const Aboutus = () => {
    return ( <div className="flex flex-col md:flex-row w-full mx-auto justify-evenly my-24 md:pt-48 ">
        <div className="h-[80vh] flex-[3] mx-10 flex-col items-center sticky top-20 hidden md:flex ">
        ...
        <div className="flex flex-[7] flex-col gap-4 sm:gap-16 px-4 sm:px-10">
